...
public class AggregateModelInfoFrame extends AbstractFrame {
    ...
    public void init(Map<String, Object> params) {
        super.init(params);
        aggregateModelDs.setItem(dataManager.reload((Entity)params.get(ITEM), EDIT_VIEW));
    }

    public void editBtnAction() {
        AbstractEditor editor = openEditor(aggregateModelDs.getItem().getMetaClass() + EDIT,
                aggregateModelDs.getItem(), WindowManager.OpenType.DIALOG);
