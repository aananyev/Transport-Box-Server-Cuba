...
package ru.itpearls.tramservercuba.web.app.dashboard.widget.bookings;
...
import static ru.itpearls.tramservercuba.web.app.dashboard.widget.bookings.BookingsWidget.CAPTION;
...
public class BookingsWidget extends AbstractFrame {
    ...
    public void init(Map<String, Object> params) {
        ...
        greenSerialChart.getAllLabels().get(1);
